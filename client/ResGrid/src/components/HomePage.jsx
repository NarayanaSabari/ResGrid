      ...
      <header className="bg-green-700 text-white shadow-lg">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-4">
            <a href="#home" className="hover:text-green-200">
              Home
            </a>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-green-600 py-2">
            <a href="#home" className="block px-4 py-2 hover:bg-green-700">
              Home
            </a>
            <a href="#about" className="block px-4 py-2 hover:bg-green-700">
              About
            </a>
            <a href="#services" className="block px-4 py-2 hover:bg-green-700">
              Services
            </a>
            <a href="#contact" className="block px-4 py-2 hover:bg-green-700">
              Contact
            </a>
          </div>
        )}
      ...
      <main className="flex-grow">
        <section id="home" className="bg-green-600 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-bold mb-4">
              Protecting Communities, Preserving Lives
            </h2>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <img
              src="https://github.com/user-attachments/assets/ae094e1f-b2d5-491b-ab32-af493412c37a"
            ...
            <div className="flex flex-wrap -mx-4">
              <div className="w-full md:w-1/2 px-4 mb-8">
                ...
                <p className="text-gray-700">
                  ResGrid is committed to building safer, more resilient
                  communities. We work tirelessly to prepare for, respond to,
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-700">
                  Stay ahead of disasters with our advanced early warning
                  system, providing timely alerts for various hazards.
                </p>
              </div>
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="text-gray-700">
                  Our trained teams are ready 24/7 to respond swiftly and
                  effectively to any disaster situation across the region.
                </p>
              </div>
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-xl font-semibold mb-4">
                ...
                <p className="text-gray-700">
                  Empower yourself and your community with our disaster
                  preparedness training programs and awareness campaigns.
                </p>
              </div>
            </div>
          </div>
